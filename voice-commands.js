...
const voiceCommands = {
    ...
    regions: {
        ...
        ta: ['பஞ்சாப்', 'ஹரியாணா', 'மகாராஷ்ட்ர', 'கர்நாடகா', 'மத்திய பிரதேசம்', 'உத்தர பிரதேசம்', 'பிஹார்', 'மேற்கு வங்கம்', 'தமிழ்நாடு', 'தெலங்கானா', 'ஆந்திர பிரதேசம்', 'ராஜஸ்தான்', 'குஜராத்', 'கேரளா', 'ஜார்கண்ட்', 'சத்தீஸ்கர்', 'அசாம்', 'இமாச்சல் பிரதேசம்', 'உத்தரகாண்ட்', 'கோவா', 'மணிப்பூர்', 'மேகாலயா', 'மிஜோரம்', 'நாகாலாந்த்', 'ஒடிசா', 'சிக்கிம்', 'திரிபுரா', 'டெல்லி'],
...
function handleNegotiationCommands(command) {
    ...
    if (buyerMatch) {
        ...
        if (command.includes('price') || command.includes('expected') || command.includes('कीमत') || command.includes('விலை') || command.includes('ధర') || command.includes('মূल्य') || command.includes('किंमत')) {
